...
export const ComponentEntanglementRefactoringTab: React.FC<RefactoringTabProps> = () => (
    <div>
        <h3>{`${getMaintainabilityTabLabel('componentEntanglement')} refactoring candidates`}</h3>
